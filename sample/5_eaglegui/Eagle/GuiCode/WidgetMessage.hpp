...
public :
   ...
   inline WidgetBase* const From()      const {return from;}
   inline const UINT        Topic()     const {return topic;}
   inline const int        Messages()  const {return msgs;}
